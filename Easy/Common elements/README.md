<h2><a href="https://www.geeksforgeeks.org/problems/common-elements1132/1?page=1&category=Sorting,Searching&sortBy=submissions">Common elements</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given three arrays sorted in increasing order. Find the elements that are common in all three arrays.<br>
